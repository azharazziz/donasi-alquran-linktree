...
const config2025: YearlyConfig = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer: "Donasi direncanakan akan ditutup pada 13 Maret 2025. Namun demikian, donasi dapat ditutup lebih awal apabila kuota donasi yang dibutuhkan telah terpenuhi.",
    },
  ],
  ...
  donationProducts: [
    ...
    },
    {
      title: "Iqro",
      image: Iqro2025,
      description: "Buku Iqro adalah metode pembelajaran membaca Al-Qur'an yang disusun secara bertahap dan sistematis untuk memudahkan pemula mengenal huruf hijaiyah hingga mampu membaca Al-Qur'an dengan lancar.",
      advantages: [
        "Disusun bertahap dari pengenalan huruf hijaiyah hingga membaca rangkaian ayat.",
        "Metode praktis dan mudah dipahami untuk anak-anak maupun dewasa.",
        "Fokus langsung pada latihan membaca tanpa mengeja panjang.",
        "Ukuran ringkas dan ringan sehingga mudah dibawa.",
        "Cocok digunakan untuk pembelajaran di rumah, TPQ, maupun sekolah.",
      ],
      reasons: [
        "Mempermudah proses belajar membaca Al-Qur'an dari dasar.",
        "Metodenya sudah terbukti luas digunakan di berbagai lembaga pendidikan Islam.",
        "Membantu meningkatkan kepercayaan diri dalam membaca huruf Arab.",
        "Efektif untuk pembelajaran mandiri maupun bimbingan guru.",
        "Menjadi langkah awal sebelum membaca mushaf Al-Qur'an."
      ],
    },
  ],
};
